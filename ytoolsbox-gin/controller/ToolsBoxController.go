...
func PostNewTool(ctx *gin.Context) {
	...
	// 提取参数
	if utils.ResolveParam(ctx, &PostNewToolBasicInfoDTOReq) != nil {
		return
	}
	...
	// 提取参数
	if utils.ResolveParam(ctx, &PostNewToolConfigInfoDTOReq) != nil {
		return
	}

	// log.Print(utils.Struct2MapViaJson(PostNewToolBasicInfoDTOReq), utils.Struct2MapViaJson(PostNewToolConfigInfoDTOReq))
...
func GetAllTools(ctx *gin.Context) {
	...
	if utils.ResolveParam(ctx, &GetAllToolsDTOReq) != nil {
		return
	}
...
func GetSpecifiedToolConfig(ctx *gin.Context) {
	...
	if utils.ResolveURI(ctx, &GetSpecifiedToolConfigDTOReqURI) != nil {
		return
	}
	if utils.ResolveQuery(ctx, &GetSpecifiedToolConfigDTOReqQuery) != nil {
		return
	}
...
func PostNewConfig(ctx *gin.Context) {
	...
	if utils.ResolveParam(ctx, &PostNewConfig) != nil {
		return
	}
	// log.Println(utils.Struct2MapViaJson(PostNewConfig))
...
func DeleteSpecifiedConfig(ctx *gin.Context) {
	...
	if utils.ResolveURI(ctx, &DeleteSpecifiedConfigDTOReq) != nil {
		return
	}
...
func GetSpecifiedToolConfigByConfigID(ctx *gin.Context) {
	...
	if utils.ResolveURI(ctx, &GetSpecifiedToolConfigByConfigID) != nil {
		return
	}
...
func PutSpecifiedToolConfigByConfigID(ctx *gin.Context) {
	...
	if utils.ResolveURI(ctx, &PutSpecifiedToolConfigByConfigIDDTOReqURI) != nil {
		return
	}
	if utils.ResolveParam(ctx, &PutSpecifiedToolConfigByConfigIDDTOReqQuery) != nil {
		return
	}
...
func PutSpecifiedToolTutorialByToolID(ctx *gin.Context) {
	...
	if utils.ResolveParam(ctx, &PutSpecifiedToolTutorialByToolIDParam) != nil {
		return
	}

...
typedef enum {
    ...
    INDEX_OPT_DBUG                      = 35,
    INDEX_OPT_INFILE                    = 36,
    INDEX_OPT_OUTFILE                   = 37,
    INDEX_OPT_CACHEFILE                 = 38,
    INDEX_OPT_VERBOSE                   = 39,
    INDEX_OPT_DECODE                    = 40,
    INDEX_OPT_FRAGROUTE                 = 41,
    INDEX_OPT_FRAGDIR                   = 42,
    INDEX_OPT_SKIP_SOFT_ERRORS          = 43,
...
#define SET_OPT_CACHEFILE(a)   STMTS( \
        DESC(CACHEFILE).optActualIndex = 38; \
...
#define VALUE_OPT_FRAGROUTE      0x1018
#define VALUE_OPT_FRAGDIR        0x1019
#define VALUE_OPT_SKIP_SOFT_ERRORS 0x101A

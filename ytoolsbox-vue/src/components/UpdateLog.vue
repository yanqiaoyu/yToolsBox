    ...
    <el-timeline>
      <el-timeline-item timestamp="2021/10/26" placement="top">
        <el-card>
          ...
          <p>
            ...
            3. 现在可以清空所有工具了
            <br />
            4. 为任务界面添加了异步的定时请求,现在任务执行情况可以实时更新了
            <br />
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/10/7" placement="top">
        <el-card>
          ...
          <p>
            1. 修复了解析配置ID异常的Bug
            <br />2. 修复了上传脚本但是执行语句是容器的Bug <br />3.
            完成了文件上传的功能 <br />4.
            完成了工具执行的功能，至此关键功能基本OK，后续开始进行完善和改进
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/10/6" placement="top">
        <el-card>
          ...
          <p>
            ...
            <br />2. 参考gorm的官方文档，解决了一个时间显示的问题 <br />3.
            使用v-loading规避了一个重复请求的Bug，提升用户体验
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/10/5" placement="top">
        <el-card>
          ...
          <p>
            ...
            <br />2. copy网上关于go-ssh的代码并融合使用 <br />3.
            完成了前端任务界面的样式展示 <br />4.
            选用级联选择器作为发起任务的前端样式，并解决了高度不一致的问题
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/10/3" placement="top">
        <el-card>
          ...
          <p>
            1. 修复了一个错误处理的Bug
            <br />2.
            优化工具的库表结构，现在分为工具基本信息与工具配置信息两张表
            <br />3. 配合后端的优化，优化前端的新增工具的步骤 <br />4.
            改用内联查询优化后端的查询逻辑
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/10/2" placement="top">
        <el-card>
          ...
          <p>
            1. 完成了工具详情展示的可携带参数跳转
            <br />2. 完成了工具搜索的功能 <br />3. 优化了后端查询工具的逻辑
      ...
      <el-timeline-item timestamp="2021/9/21" placement="top">
        <el-card>
          ...
          <p>
            1. 完成了用户状态更新
            <br />2. 解决了一个更新状态后数据库顺序紊乱的问题 <br />3.
            完成了修改用户信息的功能
            <br />
          </p>
        </el-card>
      ...
      <el-timeline-item timestamp="2021/9/15" placement="top">
        <el-card>
          ...
          <p>
            ...
            <br />2. 准备引入PostgreSQL，并着手解耦后端代码 <br />3.
            加入了一个更新日志界面 <br />4.
            用ele的avatar组件重新导入了首页的猫猫
            <br />
          </p>
        </el-card>
      </el-timeline-item>

      <el-timeline-item timestamp="2021/9/14" placement="top">
        <el-card>
          <h4>更新内容</h4>
          <p>
            1. 广州一哥解决了一个elementUI引起的Menu收起导致图标显示不全的问题
            <br />
          </p>
        </el-card>
      </el-timeline-item>
      ...
      <el-timeline-item timestamp="2021/9/3" placement="top">
        <el-card>
          <h4>更新内容</h4>
          <p>
            1. init工具盒项目
